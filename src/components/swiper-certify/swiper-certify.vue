<template>
    <div class="swiper-certify">
        ...
        >
            ...
            @click="slideClick(classRender[index],index)"  
...
export default {
    ...
    methods:{
        ...
        slideClick(cls,index){
            ...
            if(cls==self.classCenter){
                if(self.swiperOption.urls && self.swiperOption.urls[index]){
                    var win = window.open(self.swiperOption.urls[index],"_blank");
                    win.opener = null;
                }
            }
        },
