                ...
                <div class="img-preview-box ">
                    <div class="preview-content fl">
                        <div class="preview-desc" ref="cropperBox">
                            <img :src="coverUrlCurrent ? coverUrlCurrent +'?t=' +new Date().getTime() : require('@/assets/images/portrait2.png')" ref="cropperImg"
...
export default {
    ...
    methods:{
      ...
      updataImg(e){
        ...
        var fileError = this.beforeAvatarUpload(file);
        if( !fileError ){
            return;
        }
      ...
      beforeAvatarUpload(file){
        ...
        if (!isJPG) {
          this.$message.error('上传头像图片只支持JPG、PNG格式!');
        }
        if (isLt2M) {
